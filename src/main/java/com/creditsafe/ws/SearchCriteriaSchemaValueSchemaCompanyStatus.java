...
/**
 * <p>Java class for SearchCriteriaSchema.ValueSchema_CompanyStatus complex type.
 * 
...
@XmlType(name = "SearchCriteriaSchema.ValueSchema_CompanyStatus", namespace = "http://www.creditsafe.com/globaldata/datatypes", propOrder = {
    "allowedValues",
    "validationRegExp"
})
public class SearchCriteriaSchemaValueSchemaCompanyStatus {

    @XmlElement(name = "AllowedValues")
    protected SearchCriteriaSchemaValueSchemaCompanyStatus.AllowedValues allowedValues;
     ...
     * @return
     *     possible object is
     *     {@link SearchCriteriaSchemaValueSchemaCompanyStatus.AllowedValues }
     *     
     */
    public SearchCriteriaSchemaValueSchemaCompanyStatus.AllowedValues getAllowedValues() {
     ...
     *     
     */
    public void setAllowedValues(SearchCriteriaSchemaValueSchemaCompanyStatus.AllowedValues value) {
