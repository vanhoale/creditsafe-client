...
@XmlRootElement(name = "GetSupportedChangeEventsResponse", namespace = "http://www.creditsafe.com/globaldata/operations")
public class GetSupportedChangeEventsResponse {
    ...
    /**
     * Gets the value of the getSupportedChangeEventsResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the getSupportedChangeEventsResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link SupportedChangeEventsList }{@code >}
