...
@XmlRootElement(name = "DeliverOfflineCompanyReport", namespace = "http://www.creditsafe.com/globaldata/operations/administration")
public class DeliverOfflineCompanyReport {
